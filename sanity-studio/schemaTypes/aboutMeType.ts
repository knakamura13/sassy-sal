export default {
  ...
  fields: [
      ...
      fields: [
        {
          ...
          title: 'Form Header',
          description:
            "Header text that spans the full width of the page (e.g., \"From life's milestones to everyday magic, I'm here to photograph it all — let's connect.\")",
          type: 'string',
        },
        {
          name: 'formFields',
    ...
    },
    {
      ...
      description:
        'Text displayed above the email at the bottom of the page (e.g., "Lifestyle, headshot, engagement, and event photography.")',
      type: 'string',
    },
    {
      name: 'email',
